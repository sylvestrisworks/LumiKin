...
sanityType: guide
locale: en
slug: esrb-pegi-lumiscore-difference
category: game-safety
title: "ESRB, PEGI, and LumiScore — what each one actually measures"
excerpt: "ESRB and PEGI rate what is in a game. LumiScore rates what the game does to a developing brain. Same product, different question — and the answers diverge more than you'd expect."
seoTitle: "ESRB vs PEGI vs LumiScore — what each rating actually measures | LumiKin"
seoDescription: "Side-by-side: what ESRB age icons cover, what PEGI content descriptors mean, and why LumiScore can rate an ESRB E game as not recommended for children."
...
LumiScore is a 60-dimension rubric — there is a full breakdown on the [FAQ page](/en/faq#bds) — but the three families that drive most of the divergence are:
...
*[Red Dead Redemption 2](/en/game/red-dead-redemption-2)* is ESRB M (mature, 17+) and lands a LumiScore of 72 with one of the lowest RIS values in the catalogue. The content is for older players; the design isn't pulling at them. Time recommendation is the full 2-hour tier.

*[Grand Theft Auto V](/en/game/grand-theft-auto-v)*'s offline story mode is similar — ESRB M, LumiScore 63, very low RIS. The age-rating answer is "older teens and up only"; the design-rating answer is "and when they're playing, the game isn't engineered to trap them". Both answers matter; neither one is the whole picture. (The catch is the bundled online mode — covered separately in *[Bundled online modes](/en/guides/bundled-online-modes)*.)
...
- *[How much game time is healthy, by age](/en/guides/how-much-game-time-by-age)* — how LumiScore turns into a daily session length.
- *[Bundled online modes: GTA V, RDR2, and Minecraft](/en/guides/bundled-online-modes)* — the case where the content rating and the LumiScore are both right, and a third thing is the catch.
- *[The LumiScore rubric in full](/en/faq#curascore)* — the underlying formula behind every divergence above.
