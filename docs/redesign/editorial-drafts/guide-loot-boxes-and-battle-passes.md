...
sanityType: guide
locale: en
slug: loot-boxes-and-battle-passes
category: game-safety
title: "Loot boxes, battle passes, and what the law says"
excerpt: "Belgium banned loot boxes in 2018. Almost no one else followed. Here's the current legal landscape, what the research actually shows, and how LumiKin scores titles that use them."
seoTitle: "Loot boxes & battle passes — law, research, LumiKin scoring | LumiKin"
seoDescription: "Where loot boxes are regulated (and where they aren't), what peer-reviewed research links them to, and how LumiKin scores games that ship them."
...
- **The Netherlands** initially fined EA over FIFA's Ultimate Team packs in 2018; the fine was upheld in lower courts and then [overturned on appeal in 2022](https://www.raadvanstate.nl/) — the Dutch Council of State held that the packs weren't covered by the existing Gambling Act because the items weren't directly exchangeable for money.
- **The United Kingdom** ran a long government consultation that concluded in July 2022 with the [DCMS response paper](https://www.gov.uk/government/consultations/loot-boxes-in-video-games-call-for-evidence) declining to legislate, asking the industry to self-regulate instead. The resulting *Industry Code of Conduct* (2023, administered by Ukie) is voluntary.
...
1. **Loot-box spending is positively correlated with problem-gambling severity in adolescents.** Zendle and colleagues have a series of papers establishing this — for example *[Loot boxes, gambling, and problem gambling among young people](https://pmc.ncbi.nlm.nih.gov/articles/PMC8064953/)* (2021) and the earlier *[Adolescents and loot boxes](https://pmc.ncbi.nlm.nih.gov/articles/PMC6599795/)* (2019, Royal Society Open Science). The relationship is consistent across studies and large enough to matter practically.
2. **Variable-ratio reward schedules are uniquely good at producing sustained engagement.** This is older psychology, but the gaming-specific synthesis is well summarised in [Newall et al. on engineered highs and behavioural addiction](https://www.sciencedirect.com/science/article/pii/S0306460323000217) (2023). The mechanism is the same one slot machines use.
...
1. **Hard-set a no-spend rule on the kid's account.** Console parental controls and platform store settings can lock down all purchases, including in-app purchases inside free-to-play games. This is the single biggest move. Most loot-box risk evaporates the moment Real Money cannot cross the line.
2. **Watch for the "first purchase only" trap.** Most live-service games run a deeply discounted starter pack that anchors the price scale. Pre-empt the conversation before it happens, not after.
3. **Recognise the battle-pass clock.** If your kid says "I have to play before the season ends", that is exactly the design pressure working. The recommended response is to let some pass tiers expire on purpose, once, to reset the expectation.
4. **Read the LumiKin per-game Parent Tip.** Where loot-box pressure dominates, the Parent Tip on each scored game names the specific currency, the specific pack, and the specific store toggle to use.
...
- *[ESRB, PEGI, and LumiScore — what each one actually measures](/en/guides/esrb-pegi-lumiscore-difference)* — why a T rating and a 30-minute LumiKin recommendation are not contradictory.
- *[How much game time is healthy, by age](/en/guides/how-much-game-time-by-age)* — the asymmetric formula that produces the short recommendations above.
- *[Bundled online modes: GTA V, RDR2, and Minecraft](/en/guides/bundled-online-modes)* — the closely related case where the loot mechanics hide inside a single-player launcher.
