...
sanityType: post
locale: en
slug: supercell-the-hook-machine
postType: blog
title: "Inside Supercell: the studio that turned 'five more minutes' into a science"
excerpt: "The Finnish studio behind Clash of Clans and Brawl Stars ships fewer games than almost anyone — and keeps players longer than almost anyone. Here is how they do it, which mechanics do the work, and how LumiKin scores the result."
seoTitle: "Inside Supercell: why Clash of Clans & Brawl Stars are so sticky | LumiKin"
seoDescription: "How Supercell — maker of Clash of Clans, Clash Royale and Brawl Stars — engineers engagement, the specific mechanics that keep kids playing, and how LumiKin scores those games."
...
<!-- coverImage: docs/redesign/editorial-drafts/covers/post-supercell-the-hook-machine.png
     alt: "A linocut cutaway of a clockwork machine — gears, hourglasses, timed chests on a conveyor and a coin slot below; a tiny walled village and battle arena on top — the works behind a mobile game made visible." -->
...
Strip the cartoon art off a Supercell game and you find a remarkably consistent engine underneath. The same handful of mechanisms appear across Clash of Clans, Clash Royale and Brawl Stars — each one a well-studied lever on human behaviour. Here are the main ones, and the design risk each maps to in [the LumiScore rubric](/en/faq#curascore).
...
- *[Loot boxes, battle passes, and what the law says](/en/guides/loot-boxes-and-battle-passes)* — the regulation and research behind the mechanics described above.
- *[How much game time is healthy, by age](/en/guides/how-much-game-time-by-age)* — the asymmetric formula that produces the short recommendations here.
- *[Voice chat, party chat, and stranger contact](/en/guides/voice-chat-and-stranger-contact)* — the social-risk dimension that clans and clubs lean on.
